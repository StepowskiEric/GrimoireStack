# Skill Audit — writing-great-skills Pass

Track which skills have been updated per the writing-great-skills principles:
- Frontmatter cleaned (stripped metadata, added triggers, leading word in description)
- "When to Use" / "When NOT to Use" removed (triggers cover it)
- Do/Do Not rules merged into positive rules
- Negation reframed to positive
- Research basis pushed to external RESEARCH.md
- Anti-Patterns → Failure Modes (or similar positive rename)
...
- [x] `debugging/debug-subagent/SKILL.md`
- [x] `debugging/log-trace-correlation/SKILL.md`
- [x] `debugging/bug-inquisition-conquest/SKILL.md`
- [x] `debugging/abductive-first-debugging/SKILL.md`
- [x] `debugging/bisect-debugging/SKILL.md`
- [x] `debugging/bug-inquisition/SKILL.md`
- [x] `debugging/debug-issue/SKILL.md`
- [x] `debugging/debug-to-fix-pipeline/SKILL.md`
- [x] `debugging/environment-recovery/SKILL.md`
- [x] `debugging/escalation-ladder/SKILL.md`
- [x] `debugging/explore-codebase/SKILL.md`
...
- [x] `execution/intent-specification-protocol/SKILL.md`
- [x] `execution/iterative-spec-authoring/SKILL.md`
...
- [x] `execution/pragmatic-programmer-state-machine/SKILL.md`
- [x] `execution/process-reward-model-protocol/SKILL.md`
...
- [x] `judgment-and-routing/pre-mortem/SKILL.md`
- [x] `judgment-and-routing/adversarial-review/SKILL.md`
- [x] `judgment-and-routing/advocatus-diaboli/SKILL.md`
- [x] `judgment-and-routing/bayesian-updating/SKILL.md`
- [x] `judgment-and-routing/cognitive-bias-auditor/SKILL.md`
- [x] `judgment-and-routing/cognitive-bias-checklist/SKILL.md`
- [x] `judgment-and-routing/counterfactual-policy-testing/SKILL.md`
...
- [x] `judgment-and-routing/thoroughness-check-etto-state-machine/SKILL.md`
- [x] `judgment-and-routing/unsafe-control-actions-hazard-analysis/SKILL.md`

## MCP Servers (2 files)

- [x] `mcp-servers/active-inference-agent/SKILL.md`
- [x] `mcp-servers/evolutionary-tool-composer/SKILL.md`
...
- [x] `orchestration/octopus/SKILL.md`
- [x] `orchestration/scout/SKILL.md`
- [x] `orchestration/agent-memory-hygiene/SKILL.md`
- [x] `orchestration/agentic-design-patterns-orchestrator/SKILL.md`
- [x] `orchestration/agentic-design-patterns-orchestrator-state-machine/SKILL.md`
- [x] `orchestration/jury/SKILL.md`
- [x] `orchestration/monte-carlo-tree-search/SKILL.md`
- [x] `orchestration/navigator/SKILL.md`
- [x] `orchestration/pre-flight-intent-verification/SKILL.md`
...
- [x] `reasoning/hallucination-anchor-chain/SKILL.md`
- [x] `reasoning/chaos-detector/SKILL.md`
...
- [x] `reasoning/token-budget-operator/SKILL.md`

## Research (1 file)

- [x] `research/effective-web-search/SKILL.md`

## Software Development (21 files)

- [x] `software-development/verified-synthesize/SKILL.md`
...
- [x] `software-development/dev-diagnostics-mcp/SKILL.md`
...
- [x] `systems-and-architecture/cross-domain-analogy-generator/SKILL.md`
- [x] `systems-and-architecture/accelerate-ai/SKILL.md`
- [x] `systems-and-architecture/architecture-evolution-review/SKILL.md`
...
- [x] `systems-and-architecture/security-review-protocol/SKILL.md`
...
| Development | 5 | 5 | 0 |
| Execution | 31 | 31 | 0 |
| Judgment & Routing | 30 | 30 | 0 |
| MCP Servers | 2 | 2 | 0 |
| ML Ops | 1 | 1 | 0 |
| Orchestration | 17 | 17 | 0 |
| Output Quality | 12 | 12 | 0 |
| Reasoning | 13 | 13 | 0 |
| Research | 1 | 1 | 0 |
| Software Development | 21 | 21 | 0 |
| Systems & Architecture | 18 | 18 | 0 |
| Testing | 7 | 7 | 0 |
| **Total** | **176** | **176** | **0** |
