...
const AGENT_CONFIGS = {
  codex: { defaultDest: path.join(process.env.HOME, '.agents', 'skills'), flat: false },
  hermes: { defaultDest: path.join(process.env.HOME, '.hermes', 'skills'), flat: false },
  claude: { defaultDest: path.join(process.env.HOME, '.claude', 'skills'), flat: false },
  antigravity: { defaultDest: path.join(process.env.HOME, '.antigravity', 'skills'), flat: false },
  copilot: { defaultDest: path.join(process.env.HOME, '.agents', 'skills'), flat: true },
  pi: { defaultDest: path.join(process.env.HOME, '.pi', 'agent', 'skills'), flat: true },
};
