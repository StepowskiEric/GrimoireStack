...
| `context-lifecycle-manager` (absorbs token-budget-operator) | Orchestration — manage context + budget + decay + pruning |

**Recommended stack for critical tasks:**
```
1. context-lifecycle-manager (compress context + manage budget + decay + pruning)
