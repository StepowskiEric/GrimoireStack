...
Before non-trivial execution, create `agentic-run-plan.md`. For larger tasks, also create `unknowns-register.md`.

> For full templates of both artifacts, see [`references/control-artifacts.md`](references/control-artifacts.md)
