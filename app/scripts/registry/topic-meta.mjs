/**
 * topic-meta.mjs — Hand-curated school theme metadata.
 *
 * One entry per topic directory. Used as a fallback when the curated
 * overlay doesn't cover a topic. Add a new entry when introducing a
 * new topic; the registry generator will pick it up automatically.
 */
