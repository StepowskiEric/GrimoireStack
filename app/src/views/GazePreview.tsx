...
import GrimoireEye from '../components/GrimoireEye.tsx';
import VoidIncantations from '../components/VoidIncantations.tsx';
import { clamp01 } from '../utils/gaze.ts';
...
export default function GazePreview() {
  ...
  return (
    <div className="gaze-preview" data-gaze={gaze} style={{ '--gaze-veil': gaze } as React.CSSProperties}>
