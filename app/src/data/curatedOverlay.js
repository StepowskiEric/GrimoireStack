...
export const CURATED_OVERLAY = {
  'log-trace-correlation': {
    ...
    kins: ['bisect-debugging', 'root-cause-analysis', 'debug-subagent', 'simulate-instrumentation'],
    combos: ['Bisect Divination', 'Root Cause Revelation', 'Spectral Analysis'],
  },
  'bisect-debugging': {
    ...
    combos: ['Trace Sight', 'Iterative Mend', 'Root Cause Revelation'],
  },
  'debug-subagent': {
    displayName: 'Debug Subagent',
    trueName: 'Familiar of the Debug',
    status: 'Proven',
    kins: ['log-trace-correlation', 'root-cause-analysis', 'simulate-instrumentation', 'specter'],
    combos: ['Instrumentation Charm', 'Spectral Analysis', 'Scout Protocol'],
  },
  'purify-test-output': {
    ...
    combos: ['Instrumentation Charm', 'Test Oracle', 'Iterative Mend'],
  },
  'simulate-instrumentation': {
  ...
  'root-cause-analysis': {
    ...
    combos: ["Occam\\'s Verdict", 'Trace Sight', 'Bisect Divination'],
  },
  'debug-issue': {
  ...
  'long-task-survival-kit': {
    ...
    status: '—',
    combos: ['Trajectory Warden', 'Context Lifecycle', 'Grounding Ritual'],
  },
  'time-traveling-debugger': {
    displayName: 'Time-Travel Debugger',
    trueName: 'The Temporal Rewind',
    status: 'MCP',
    kins: ['bisect-debugging', 'log-trace-correlation', 'iterative-patch-repair'],
  },
  ...
  'occams-razor': {
    ...
    status: 'New',
    kins: ['root-cause-analysis', 'first-principles', 'specter'],
  },
  ...
  'pre-deployment-gate': {
    ...
    status: '—',
    combos: ['Security Warding', 'Vibe Hardening', 'LLM Pre-Push Ward', 'Failure Prophecy'],
  },
