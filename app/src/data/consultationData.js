    ...
    narrowing: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'dbg-n2-c', label: 'A test that should exist, but does not',         sigilGlyph: '\u2756', primary: 'minimal-reproduction',      alt: 'purify-test-output',      reason: 'No failing test is a wound un-named.' },
          { id: 'dbg-n2-d', label: 'A test of the test, the meta-ritual',            sigilGlyph: '\u29c8', primary: 'verified-synthesize',       alt: 'minimal-reproduction',    reason: 'Provable correctness outranks hope.' },
        ],
      },
      {
        id: 'dbg-n3',
        ...
        options: [
          ...
          { id: 'dbg-n3-c', label: 'By conjuring a familiar to tend the wound',      sigilGlyph: '\u2698', primary: 'debug-subagent',            alt: 'specter',                 reason: 'A dedicated debugger before any edit.' },
          { id: 'dbg-n3-d', label: 'By watching values as they pass',                sigilGlyph: '\u25ce', primary: 'simulate-instrumentation',  alt: 'iterative-patch-repair',  reason: 'You cannot fix what you cannot see.' },
        ],
      },
      {
        id: 'dbg-n4',
        ...
        options: [
          ...
          { id: 'dbg-n4-c', label: 'A spell no longer in the registry',              sigilGlyph: '\u2625', primary: 'api-surface-anchoring',     alt: 'environment-recovery',   reason: 'The API moved; the spell did not.' },
          { id: 'dbg-n4-d', label: 'A regression, in the most recent commit',        sigilGlyph: '\u21bb', primary: 'bisect-debugging',          alt: 'time-traveling-debugger', reason: 'It worked once. Find when it stopped.' },
        ],
      },
    ],
    darker: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'dbg-d2-c', label: 'A pact with the silent subagent',                sigilGlyph: '\u2698', primary: 'debug-subagent',            alt: 'specter',                 reason: 'A dedicated familiar knows the wound.' },
          { id: 'dbg-d2-d', label: 'A ritual of trial, error, and time reversal',    sigilGlyph: '\u21bb', primary: 'time-traveling-debugger',   alt: 'bisect-debugging',         reason: 'Record forward, rewind to the divergence.' },
        ],
      },
    ],
  },
    ...
    narrowing: [
      {
        ...
        options: [
          ...
          { id: 'rsn-n1-c', label: 'A mask of false certainty',                      sigilGlyph: '\u2756', primary: 'self-contradiction-trap',   alt: 'self-consistency',        reason: 'Beliefs that contradict themselves are loud.' },
          { id: 'rsn-n1-d', label: 'A mask of impossibility',                       sigilGlyph: '\u2620', primary: 'socratic-clarification',     alt: 'cross-domain-analogy-generator', reason: 'When all paths look blocked, reach across domains.' },
        ],
      },
      {
        id: 'rsn-n2',
        ...
        options: [
          ...
          { id: 'rsn-n2-c', label: 'A fog of too much context',                     sigilGlyph: '\u2601', primary: 'context-rot-pruner',        alt: 'context-density-operator', reason: 'Old context rots; prune with decay.' },
          { id: 'rsn-n2-d', label: 'A weight of stale memory',                      sigilGlyph: '\u2691', primary: 'context-density-operator',  alt: 'context-rot-pruner',     reason: 'Compress to retain only what changes the decision.' },
        ],
      },
      {
        id: 'rsn-n3',
        ...
        options: [
          ...
          { id: 'rsn-n3-c', label: 'By speaking it aloud, for others to weigh',      sigilGlyph: '\u2756', primary: 'stakeholder-communication', alt: 'metacognitive-monitoring', reason: 'A claim you can defend has weight.' },
          { id: 'rsn-n3-d', label: 'By trying many paths at once',                  sigilGlyph: '\u2042', primary: 'tree-of-thoughts',           alt: 'self-consistency',        reason: 'Branching and pruning beats linear search.' },
        ],
      },
      {
        id: 'rsn-n4',
        ...
        options: [
          ...
          { id: 'rsn-n4-c', label: 'The one seen by all sides at once',              sigilGlyph: '\u2042', primary: 'six-thinking-hats',         alt: 'metacognitive-monitoring', reason: 'Multiple lenses reduce single-view error.' },
          { id: 'rsn-n4-d', label: 'The one that survives contradiction',            sigilGlyph: '\u2756', primary: 'self-consistency',          alt: 'self-contradiction-trap', reason: 'Truth tested by independent paths.' },
        ],
      },
    ],
    darker: [
      {
        ...
        options: [
          ...
          { id: 'rsn-d1-c', label: 'A pattern, finally visible',                    sigilGlyph: '\u2756', primary: 'self-consistency',          alt: 'tree-of-thoughts',       reason: 'Many paths converging on one shape.' },
          { id: 'rsn-d1-d', label: 'A question, sharper than before',                sigilGlyph: '\u269c', primary: 'socratic-clarification',    alt: 'first-principles',        reason: 'The answer you needed was the next question.' },
        ],
      },
      {
        id: 'rsn-d2',
        ...
        options: [
          ...
          { id: 'rsn-d2-c', label: 'Your certainty of speed',                       sigilGlyph: '\u23f2', primary: 'selective-halt-reasoning',  alt: 'context-rot-pruner',     reason: 'Stop when the conclusion is stable.' },
          { id: 'rsn-d2-d', label: 'Your chain of evidence',                        sigilGlyph: '\u2756', primary: 'reasoning-integrity-chain', alt: 'hallucination-anchor-chain', reason: 'Every claim needs an anchor.' },
        ],
      },
    ],
  },
    ...
    narrowing: [
      {
        ...
        options: [
          ...
          { id: 'sde-n1-c', label: 'To remain stable when the storm comes',          sigilGlyph: '\u2693', primary: 'release-it-stability',      alt: 'sre-error-budget',       reason: 'Survival under load is a feature.' },
          { id: 'sde-n1-d', label: 'To defend against the next maintainer',           sigilGlyph: '\u2620', primary: 'api-design-backward-compatibility', alt: 'super-review-typescript', reason: 'Contracts outlive their authors.' },
        ],
      },
      {
        id: 'sde-n2',
        ...
        options: [
          ...
          { id: 'sde-n2-c', label: 'A web of small, coordinated changes',             sigilGlyph: '\u26d4', primary: 'coordinated-change',        alt: 'lint-battalion',         reason: 'Atomic across the surface that depends.' },
          { id: 'sde-n2-d', label: 'A monument to past selves',                       sigilGlyph: '\u2620', primary: 'git-surgery',               alt: 'verify-before-integrate', reason: 'When history is broken, surgery is needed.' },
        ],
      },
      {
        id: 'sde-n3',
        ...
        options: [
          ...
          { id: 'sde-n3-c', label: 'The many eyes of the deployment gate',            sigilGlyph: '\u26d4', primary: 'pre-deployment-gate',       alt: 'security-review-protocol', reason: 'Seven passes, one threshold.' },
          { id: 'sde-n3-d', label: 'A critical system, unforgiving',                  sigilGlyph: '\u2620', primary: 'critical-system-interrogation', alt: 'pre-deployment-gate', reason: 'Auth, payment, validation, all of it.' },
        ],
      },
      {
        id: 'sde-n4',
        ...
        options: [
          ...
          { id: 'sde-n4-c', label: 'A secret left in the open',                      sigilGlyph: '\u26d4', primary: 'security-review-protocol',  alt: 'pre-deployment-gate',   reason: 'Hardening before exposure.' },
          { id: 'sde-n4-d', label: 'A path the test runner never saw',                sigilGlyph: '\u2042', primary: 'dev-diagnostics-mcp',       alt: 'lint-battalion',         reason: 'The tooling knows what eyes cannot see.' },
        ],
      },
    ],
    darker: [
      {
        ...
        options: [
          ...
          { id: 'sde-d1-c', label: 'The watcher, who never slept',                   sigilGlyph: '\u25ce', primary: 'verify-before-integrate',   alt: 'pre-deployment-gate',   reason: 'Vigilance beyond the commit.' },
          { id: 'sde-d1-d', label: 'The user, who trusted',                          sigilGlyph: '\u2620', primary: 'stakeholder-communication', alt: 'security-review-protocol', reason: 'Communication is a safety feature.' },
        ],
      },
      {
        id: 'sde-d2',
        ...
        options: [
          ...
          { id: 'sde-d2-c', label: 'Readiness for the worst hour',                   sigilGlyph: '\u2693', primary: 'release-it-stability',      alt: 'sre-error-budget',       reason: 'Stability under failure is the bar.' },
          { id: 'sde-d2-d', label: 'A heart, in the chaos',                          sigilGlyph: '\u2756', primary: 'sre-error-budget',          alt: 'release-it-stability',   reason: 'The error budget is the heartbeat.' },
        ],
      },
    ],
  },
    ...
    narrowing: [
      {
        ...
        options: [
          ...
          { id: 'arc-n1-c', label: 'A map of how teams divide the work',             sigilGlyph: '\u2042', primary: 'team-topologies-ai',        alt: 'domain-driven-design',    reason: 'Boundaries are organizational.' },
          { id: 'arc-n1-d', label: 'A vision of the whole system',                   sigilGlyph: '\u26d4', primary: 'system-architecture-audit', alt: 'designing-data-intensive-applications-ai', reason: 'Map, then judge.' },
        ],
      },
      {
        id: 'arc-n2',
        ...
        options: [
          ...
          { id: 'arc-n2-c', label: 'Survival of the storm',                          sigilGlyph: '\u26d4', primary: 'release-it-stability',      alt: 'sre-error-budget',         reason: 'Stable in failure is the design.' },
          { id: 'arc-n2-d', label: 'Strength against the dark',                      sigilGlyph: '\u2620', primary: 'security-threat-modeling',  alt: 'security-review-protocol', reason: 'The adversary is always considered.' },
        ],
      },
      {
        id: 'arc-n3',
        ...
        options: [
          ...
          { id: 'arc-n3-c', label: 'Between the abstract and the code',              sigilGlyph: '\u2756', primary: 'everything-as-code-conceptualizer', alt: 'system-architecture-audit', reason: 'Codify the system to reveal it.' },
          { id: 'arc-n3-d', label: 'Between past and future decisions',              sigilGlyph: '\u25c7', primary: 'accelerate-ai',             alt: 'team-topologies-ai',       reason: 'The decisions compound.' },
        ],
      },
      {
        id: 'arc-n4',
        ...
        options: [
          ...
          { id: 'arc-n4-c', label: 'A risk, lurking in the choices',                 sigilGlyph: '\u2620', primary: 'pre-mortem',                alt: 'inversion-mental-model',   reason: 'Imagine failure first.' },
          { id: 'arc-n4-d', label: 'An idea, borrowed from afar',                    sigilGlyph: '\u2042', primary: 'cross-domain-analogy-generator', alt: 'socratic-clarification', reason: 'Break fixation with foreign structure.' },
        ],
      },
    ],
    darker: [
      {
        ...
        options: [
          ...
          { id: 'arc-d1-c', label: 'A promise, that no one kept',                    sigilGlyph: '\u2756', primary: 'release-it-stability',      alt: 'sre-error-budget',        reason: 'SLOs are promises; budgets are honesty.' },
          { id: 'arc-d1-d', label: 'An enemy, waiting patiently',                    sigilGlyph: '\u2620', primary: 'security-threat-modeling',  alt: 'security-review-protocol', reason: 'STRIDE finds the adversary\u2019s path.' },
        ],
      },
      {
        id: 'arc-d2',
        ...
        options: [
          ...
          { id: 'arc-d2-c', label: 'The boundary, drawn too thin',                   sigilGlyph: '\u26d4', primary: 'security-threat-modeling',  alt: 'security-review-protocol', reason: 'The trust boundary betrayed.' },
          { id: 'arc-d2-d', label: 'The decision, long deferred',                    sigilGlyph: '\u23f2', primary: 'accelerate-ai',             alt: 'thinking-in-systems-state-machine', reason: 'Latency is a system property.' },
        ],
      },
    ],
  },
    ...
    narrowing: [
      {
        ...
        options: [
          ...
          { id: 'tst-n1-c', label: 'The code, by other eyes',                        sigilGlyph: '\u2756', primary: 'review-ladder-plus',        alt: 'verify-before-integrate', reason: 'Forced test generation and "why is it safe".' },
          { id: 'tst-n1-d', label: 'The test\u2019s output, sliced to truth',          sigilGlyph: '\u23f2', primary: 'purify-test-output',        alt: 'skill-ab-evaluation',     reason: 'Sliced test output is the cleanest signal.' },
        ],
      },
      {
        id: 'tst-n2',
        ...
        options: [
          ...
          { id: 'tst-n2-c', label: 'With a chorus of critics, in layers',            sigilGlyph: '\u2756', primary: 'review-ladder-plus',        alt: 'llm-pre-push-review',     reason: 'Forced test generation and "why is it safe".' },
          { id: 'tst-n2-d', label: 'With the final deployment gate',                  sigilGlyph: '\u26d4', primary: 'pre-deployment-gate',       alt: 'skill-ab-evaluation',     reason: 'One threshold; many passes.' },
        ],
      },
      {
        id: 'tst-n3',
        ...
        options: [
          ...
          { id: 'tst-n3-c', label: 'Whether the commit is clean',                   sigilGlyph: '\u25ce', primary: 'verify-before-integrate',   alt: 'llm-pre-push-review',     reason: 'Pre-commit, pre-regret.' },
          { id: 'tst-n3-d', label: 'Whether the ship is safe',                       sigilGlyph: '\u26d4', primary: 'pre-deployment-gate',       alt: 'review-ladder-plus',      reason: 'Production-ready, by seven tests.' },
        ],
      },
      {
        id: 'tst-n4',
        ...
        options: [
          ...
          { id: 'tst-n4-c', label: 'A new review is born, of the failing one',       sigilGlyph: '\u2756', primary: 'llm-pre-push-review',       alt: 'review-ladder-plus',     reason: 'Pre-push, pre-regret.' },
          { id: 'tst-n4-d', label: 'The skill itself is questioned',                 sigilGlyph: '\u2042', primary: 'skill-ab-evaluation',       alt: 'pre-deployment-gate',    reason: 'Even skills need to earn their place.' },
        ],
      },
    ],
    darker: [
      {
        ...
        options: [
          ...
          { id: 'tst-d1-c', label: 'The skill is untested',                          sigilGlyph: '\u2042', primary: 'skill-ab-evaluation',       alt: 'pre-deployment-gate',    reason: 'A skill without evaluation is hearsay.' },
          { id: 'tst-d1-d', label: 'The framework has hidden the truth',             sigilGlyph: '\u2756', primary: 'review-ladder-plus',        alt: 'llm-pre-push-review',    reason: 'Reviews can lie; integration is honest.' },
        ],
      },
      {
        id: 'tst-d2',
        ...
        options: [
          ...
          { id: 'tst-d2-c', label: 'An agreement, easily broken',                    sigilGlyph: '\u26d4', primary: 'pre-deployment-gate',       alt: 'skill-ab-evaluation',    reason: 'A passing gate is a fragile contract.' },
          { id: 'tst-d2-d', label: 'A foundation, if the foundation is true',         sigilGlyph: '\u23f2', primary: 'verify-before-integrate',   alt: 'llm-pre-push-review',    reason: 'Build on solid gates or build on sand.' },
        ],
      },
    ],
  },
    ...
    narrowing: [
      {
        ...
        options: [
          ...
          { id: 'out-n1-c', label: 'A clear skeleton, MECE and true',                 sigilGlyph: '\u2042', primary: 'mece-pyramid-principle',    alt: 'large-documentation-navigation', reason: 'Mutually exclusive, collectively exhaustive.' },
          { id: 'out-n1-d', label: 'A calibration of confidence',                     sigilGlyph: '\u25ce', primary: 'stakeholder-communication', alt: 'prism',                   reason: 'Confidence stated is a deliverable.' },
        ],
      },
      {
        id: 'out-n2',
        ...
        options: [
          ...
          { id: 'out-n2-c', label: 'By trying many paths at once',                    sigilGlyph: '\u2756', primary: 'tree-of-thoughts',           alt: 'self-consistency',        reason: 'Branch, evaluate, prune.' },
          { id: 'out-n2-d', label: 'By independent paths to the same truth',          sigilGlyph: '\u2042', primary: 'self-consistency',          alt: 'tree-of-thoughts',         reason: 'Convergent paths are robust.' },
        ],
      },
      {
        id: 'out-n3',
        ...
        options: [
          ...
          { id: 'out-n3-c', label: 'A structure without a skeleton',                  sigilGlyph: '\u2756', primary: 'mece-pyramid-principle',    alt: 'tree-of-thoughts',         reason: 'Structure first, prose second.' },
          { id: 'out-n3-d', label: 'A path not yet considered',                      sigilGlyph: '\u2042', primary: 'tree-of-thoughts',           alt: 'self-consistency',        reason: 'More branches, better pruning.' },
        ],
      },
      {
        id: 'out-n4',
        ...
        options: [
          ...
          { id: 'out-n4-c', label: 'The chain of evidence',                          sigilGlyph: '\u2756', primary: 'tool-interactive-critic',   alt: 'self-verify-pipeline',     reason: 'Every claim must earn its place.' },
          { id: 'out-n4-d', label: 'The depth of the topic',                         sigilGlyph: '\u25ce', primary: 'large-documentation-navigation', alt: 'documentation-craft', reason: 'The reader can find their way.' },
        ],
      },
    ],
    darker: [
      {
        ...
        options: [
          ...
          { id: 'out-d1-c', label: 'Those who already knew',                         sigilGlyph: '\u2756', primary: 'stakeholder-communication', alt: 'documentation-craft',     reason: 'Calibrate to the audience.' },
          { id: 'out-d1-d', label: 'Those who ask the right questions',              sigilGlyph: '\u2042', primary: 'mece-pyramid-principle',    alt: 'socratic-clarification',   reason: 'Structure invites the right questions.' },
        ],
      },
      {
        id: 'out-d2',
        ...
        options: [
          ...
          { id: 'out-d2-c', label: 'The unseen alternatives, unconsidered',           sigilGlyph: '\u2756', primary: 'tree-of-thoughts',           alt: 'self-consistency',        reason: 'Branch before pruning.' },
          { id: 'out-d2-d', label: 'The truths, but not all of them',                 sigilGlyph: '\u2042', primary: 'self-consistency',          alt: 'reasoning-integrity-chain', reason: 'Convergent paths surface most truths.' },
        ],
      },
    ],
  },
