...
export default function TentacleSvg({ sanity }) {
  ...
  return (
    ...
    >
      ...
      {/* Top-left tentacles */}
      <g className="seance-tentacles__arm seance-tentacles__arm--tl">
      ...
      {/* Top-right tentacles */}
      <g className="seance-tentacles__arm seance-tentacles__arm--tr">
      ...
      <g className="seance-tentacles__arm seance-tentacles__arm--bl">
      ...
      <g className="seance-tentacles__arm seance-tentacles__arm--br">
      ...
      {/* Left edge tentacles */}
      <g className="seance-tentacles__arm seance-tentacles__arm--l">
      ...
      <g className="seance-tentacles__arm seance-tentacles__arm--r">
