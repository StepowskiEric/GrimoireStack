...
import { SEANCE_MAX_SANITY } from '../../data/consultationData.ts';
 ...
 */
export default function SanityMeter({ sanity, maxSanity = SEANCE_MAX_SANITY }: { sanity: number; maxSanity?: number }) {
