...
import { useRitualOrchestrator } from '../hooks/useRitualOrchestrator.ts';
...
import GrimoireEye from './GrimoireEye.tsx';
import Icon from './Icon.tsx';
import LanguageToggle from './LanguageToggle.tsx';
import LibraryContent from './LibraryContent.tsx';
import RecipeLabView from './RecipeLabView.tsx';
import RitualPanel from './RitualPanel.tsx';
import SchoolSigil from './SchoolSigil.tsx';
import SettingsView from './SettingsView.tsx';
import SpellCard from './SpellCard.tsx';
import SpellDetailView from './SpellDetailView.tsx';
import SpellWeb from './SpellWeb.tsx';
import '../styles/components/grimoire-eye.css';
import '../styles/components/gaze.css';
import { useGaze } from '../hooks/useGaze.ts';
import SchoolCardGrid from './SchoolCardGrid.tsx';
import VoidIncantations from './VoidIncantations.tsx';
import WanderingAnimation from './WanderingAnimation.tsx';
import './ModalSuspense.css';

const SCHOOL_MAP = grimoireIndex.getSchoolMap();

const CommuneView = lazy(() => import('./CommuneView.tsx'));
const GazePreview = import.meta.env.DEV ? lazy(() => import('../views/GazePreview.tsx')) : null;
...
export default function GrimoireStackLayout({
  ...
  const [wandering, setWandering] = useState<{ spell: any; school: any } | null>(null);

  // Intercept spell opens from the ritual flow to show the wandering animation first
  const handleRitualSpellOpen = useCallback((spell: any, school: any) => {
  ...
  const activeTab = (() => {
    ...
    if (path === '/bestiary') return TABS.LIBRARY;
  ...
  return (
    <div
      ...
      data-gaze={gaze}
      style={{ '--gaze-veil': gaze } as React.CSSProperties}
    >
