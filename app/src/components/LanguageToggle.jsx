  ...
  return (
    <button
      ...
      className={cn(
        ...
        isGrimoire && 'border-[rgba(212,175,55,0.5)] bg-gradient-to-b from-[rgba(80,52,18,0.7)] to-[rgba(50,32,12,0.7)] text-[#d4af37] shadow-[0_0_16px_rgba(212,175,55,0.12)]',
      )}
    ...
    >
      <span className="inline-flex h-[18px] w-[18px] items-center justify-center rounded-full border border-[rgba(212,175,55,0.45)] bg-radial text-[0.7rem] leading-none text-[#f1d08a] shadow-[0_0_10px_rgba(212,175,55,0.18),inset_0_0_6px_rgba(0,0,0,0.35)]" aria-hidden="true" style={isGrimoire ? { background: 'radial-gradient(circle at 40% 35%, #d4af37, #8a6a30 65%, #4a3416)', color: '#2a1a08', boxShadow: '0 0 10px rgba(212,175,55,0.32), inset 0 0 6px rgba(0,0,0,0.2)' } : undefined}>
