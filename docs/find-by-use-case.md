...
| d05                                                    |
| 4f4                                                    |                                                                                                      | Before any significant task — prevent confidently doing the wrong thing     | [`pre-flight-intent-verification`](../orchestration/pre-flight-intent-verification/SKILL.md) | Clarify → Specify → Ground gate: surfaces critical assumptions, crystallizes intent into testable scenarios, verifies facts before acting | New |
