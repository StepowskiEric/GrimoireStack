...
- Don't use when the bug is local: `debug-to-fix-pipeline` for single-module runtime evidence, `debug-issue` once you know the bug crosses a module/service boundary.
