...
Select skills based on the task. **Always** load `subagent-laws` (plus a test-first discipline for code). Add domain-specific skills (e.g., `security-review-protocol`, `feature-architecture`).
